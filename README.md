# Aula Introdutória de Análise Exploratória de Dados com Jupyter
...
[Referência de legendas Matplotlib](https://matplotlib.org/api/_as_gen/matplotlib.pyplot.legend.html)

[Violin plot wikipedia](https://en.wikipedia.org/wiki/Violin_plot)

[Box plot wikipedia - Portugues](https://pt.wikipedia.org/wiki/Diagrama_de_caixa)

[IQR - Interquartile Range (Wikipedia)](https://en.wikipedia.org/wiki/Interquartile_range)

[Livro Recomendado para Introdução à Machine Learning](https://www-bcf.usc.edu/~gareth/ISL/)
